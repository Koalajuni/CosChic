            ...
            <div className="w-full bg-white px-4">
                <div className="max-w-[1240px] mx-auto grid md:grid-cols-2">
                    ...
                    <div className="flex flex-col justify-center">
                        <h1 className="text-[#00df9a] font-bold p-2">인공지능을 통해 고객의 얼굴 유형에 맞춤형 화장품과 뷰티 스타일을 추천해주는 혁신적인 웹!!!</h1>
                        <p className="p-2 md:text-5xl sm:text-4xl text-3xl font-bold md:py-6">웹 기능</p>
                        <div className="p-2">
...
<button className="bg-[#00C9A7] w-[200px] rounded-md font-medium my-6 mx-auto py-3 text-black">Get Start</button>
                    </div>
                </div>
