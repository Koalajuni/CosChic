    ...
    return (
        <div className="HERO text-white">
            <div className="py-10 max-w-[800px] mt-[40px] w-full mx-auto text-center flex flex-col justify-center">
                ...
                <button className="bg-[#00C9A7] w-[200px] rounded-md font-medium my-6 mx-auto py-3 text-black">로그인</button>
                <button className="bg-[#00C9A7] w-[200px] rounded-md font-medium my-6 mx-auto py-3 text-black">회원가입</button>
            </div>
        </div>
    )
}