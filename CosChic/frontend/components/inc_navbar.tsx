...
export default function IncHero() {
    ...
    return (
        <div className="NAV">
            ...
            >
                <h1 className="w-full text-3xl font-bold text-[##F9F871] m-4">COSCHIC</h1> {/* 배경 색 변경 */}
                <ul className="hidden md:flex">
                    <li className="p-2" style={{ color: '#FFFFFF', width: '100px' }}>홈</li> {/* 글씨 색 변경 및 너비 수정 */}
                    <li className="p-2" style={{ color: '#FFFFFF', width: '100px' }}>검색</li> {/* 글씨 색 변경 및 너비 수정 */}
                    <li className="p-2" style={{ color: '#FFFFFF', width: '100px' }}>내프로필</li> {/* 글씨 색 변경 및 너비 수정 */}
                    <li className="p-2" style={{ color: '#FFFFFF', width: '100px' }}>팀소개</li> {/* 글씨 색 변경 및 너비 수정 */}
                    <li className="p-2" style={{ color: '#FFFFFF', width: '100px' }}>문의</li> {/* 글씨 색 변경 및 너비 수정 */}
                </ul>
