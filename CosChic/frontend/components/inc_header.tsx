        ...
        <header className="bg-white">
            <nav className="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
                ...
                --> */}
                    ...
                    <a href="#" className="text-sm font-semibold leading-6 text-gray-900">내 프로필</a>
                    <a href="#" className="text-sm font-semibold leading-6 text-gray-900">모델 리스트</a>
                    <a href="#" className="text-sm font-semibold leading-6 text-gray-900">브랜드 리스트</a>
                </div>
