...
class BeautyGAN:
    def __init__(self):
        ...
        self.sp = dlib.shape_predictor('./model/dlib/shape_predictor_5_face_landmarks.dat')
        self.sess = tf.Session()
        self.sess.run(tf.global_variables_initializer())
        self.saver = tf.train.import_meta_graph('./model/gan/model.meta')
        self.saver.restore(self.sess, tf.train.latest_checkpoint('./model/gan'))
